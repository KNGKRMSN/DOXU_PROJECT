/// @description Combo Stuff and Boxes
// You can write your code in this editor
isgettingcomboedpreviouswindguy = isgettingcomboed;
if (isgettingcomboed == 0 && opponent.isgettingcomboed == 0 && dash == false)
{
	global.DamageReduction = 1;
	if (currentHealth < maxHealth && room_get_name(room) == "rm_FightTest")
		currentHealth += 5;
	if (currentSpecial <= 7 && room_get_name(room) == "rm_FightTest")
		currentSpecial += 1;
	else if (currentSpecial > 7 && currentSpecial < 7.9)
		currentSpecial += 0.1;
}
